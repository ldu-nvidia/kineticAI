package com.kineticai.app.service
...
import com.kineticai.app.sensor.DualImuData
import com.kineticai.app.sensor.ThermalVisionData
import com.kineticai.app.sensor.TriSegmentData
import com.kineticai.app.sensor.MicData
import com.kineticai.app.sensor.ProximityData
import com.kineticai.app.sensor.LocationSample
import com.kineticai.app.sensor.LocationTracker
import com.kineticai.app.sensor.SensorCollector
...
class SkiTrackingService : Service() {
    ...
    suspend fun saveCurrentRun(): Long {
        val repo = RunRepository((application as KineticAIApp).database)
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, KineticAIApp.TRACKING_CHANNEL_ID)
    ...
    private fun acquireWakeLock() {
        try {
            ...
            wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "kineticai:tracking")
    ...
    companion object {
        ...
        const val ACTION_START = "com.kineticai.ACTION_START_TRACKING"
        const val ACTION_STOP = "com.kineticai.ACTION_STOP_TRACKING"
