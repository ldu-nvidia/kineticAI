...
class SnowboardAnalysisEngine(sampleRateHz: Float = 50f) {
    ...
    private fun updateMetrics(timestamp: Long, roll: Float, pitch: Float, lateralG: Float) {
        ...
        val rideIQ = computeRideScore(edgingScore, boardControlScore, pressureScore, balScore, styleScore)
    ...
    private fun computeRideScore(edging: Float, boardControl: Float, pressure: Float, balance: Float, style: Float): Int {
