...
data class SkiMetrics(
    ...
    // ── FATIGUE ──
    val fatigueIndicator: Float = 0f,       // 0=fresh, 100=exhausted (Kinetic Score decline rate)
    val skiIQTrend: Float = 0f,             // positive=improving, negative=declining
    val earlyRunKineticScore: Float = 0f,          // avg Kinetic Score from first 10 turns
    val currentWindowKineticScore: Float = 0f,     // avg Kinetic Score from last 10 turns
    ...
    // ── ADAPTIVE SCORING ──
    val personalBestKineticScore: Int = 0,         // highest Kinetic Score ever achieved
    val personalBaselineKineticScore: Float = 0f,  // baseline from first 50 turns
