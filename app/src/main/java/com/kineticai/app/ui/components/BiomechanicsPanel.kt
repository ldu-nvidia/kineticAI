        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            if (tri != null && tri.bnoPresent) {
                ...
                MetricRow(
                    ...
                    when (tri.chainOrder) {
                        com.kineticai.app.sensor.ChainOrder.BOTTOM_UP -> AccentGreen
                        com.kineticai.app.sensor.ChainOrder.TOP_DOWN -> AccentOrange
                        com.kineticai.app.sensor.ChainOrder.SIMULTANEOUS -> AccentYellow
                    },
                    when (tri.chainOrder) {
                        com.kineticai.app.sensor.ChainOrder.BOTTOM_UP -> "Expert: feet initiate movement"
                        com.kineticai.app.sensor.ChainOrder.TOP_DOWN -> "Upper body leading — use your feet"
                        com.kineticai.app.sensor.ChainOrder.SIMULTANEOUS -> "Rigid — develop independent segments"
                    },
                )
