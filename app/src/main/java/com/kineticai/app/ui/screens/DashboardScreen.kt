...
fun DashboardScreen(
    ...
    Column(
        ...
        Row(
            ...
            MetricCard(
                label = "Avg Kinetic Score",
                value = "${stats.avgKineticScore}",
                unit = "/ 200",
                accentColor = AccentGreen,
                modifier = Modifier.weight(1f),
                onClick = { onMetricClick("avg_kinetic_score") },
            )
        }
        ...
        Row(
            ...
            MetricCard(
                label = "Peak Kinetic Score",
                value = "${stats.peakKineticScore}",
                unit = "/ 200",
                accentColor = AccentGreen,
                modifier = Modifier.weight(1f),
                onClick = { onMetricClick("peak_kinetic_score") },
            )
            MetricCard(
                label = "Top Speed",
