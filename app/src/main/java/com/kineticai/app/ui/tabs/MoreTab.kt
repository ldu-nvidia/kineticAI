...
fun MoreTab(
    ...
    Column(
        ...
        SettingsSection("Configuration") {
            ...
            SettingsRow(Icons.Filled.Key, "API Keys", "Configure keys for weather, AI coaching, resort data") {}
        }
        ...
        SettingsSection("Legal & Safety") {
            SettingsRow(Icons.Filled.Security, "Privacy Policy", "How your data is collected, processed, and stored") {
                onNavigateToPrivacy()
            }
            SettingsRow(Icons.Filled.Warning, "Safety Disclaimers", "Important safety information and limitations") {
                onNavigateToDisclaimer()
            }
            SettingsRow(Icons.Filled.Gavel, "Open Source Licenses", "Third-party libraries and their licenses") {
                onNavigateToLicenses()
            }
            SettingsRow(Icons.Filled.Description, "Terms of Use", "Usage terms and conditions") {}
        }
        ...
        Card(
            ...
            Column(
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text(
                    text = "Built with Madgwick AHRS, multi-sensor fusion,\n" +
                        "dual-boot BLE IMU, and a passion for sports.",
