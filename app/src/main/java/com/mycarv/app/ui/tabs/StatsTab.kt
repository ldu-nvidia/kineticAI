...
import com.mycarv.app.ui.screens.MetricDetailScreen
import com.mycarv.app.ui.screens.PostAnalysisScreen
    ...
    LazyColumn(
        ...
        item {
            Row(
                ...
                MetricCard("Avg Ski:IQ", "${stats.avgSkiIQ}", unit = "/ 200", accentColor = AccentGreen,
                    modifier = Modifier.weight(1f), onClick = { onMetricClick("avg_ski_iq") })
            }
        }
        ...
        item {
            Row(
                ...
                MetricCard("Peak Ski:IQ", "${stats.peakSkiIQ}", unit = "/ 200", accentColor = AccentGreen,
                    modifier = Modifier.weight(1f), onClick = { onMetricClick("peak_ski_iq") })
