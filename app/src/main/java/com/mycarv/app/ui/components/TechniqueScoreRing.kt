...
/**
 * Displays the Ski:IQ score (0–200) in an animated ring.
 */
@Composable
fun SkiIQRing(
    skiIQ: Int,
...
@Composable
@Deprecated("Use SkiIQRing instead", replaceWith = ReplaceWith("SkiIQRing(score, modifier)"))
fun TechniqueScoreRing(
    score: Int,
    modifier: Modifier = Modifier,
) {
    SkiIQRing(skiIQ = score, modifier = modifier)
}
