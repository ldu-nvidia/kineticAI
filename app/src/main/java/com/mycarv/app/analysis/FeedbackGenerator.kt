 ...
 *
 * Real-time tips follow Carv's approach:
 ...
 *
 * Coaching language is modeled after Carv, PSIA, and professional
...
class FeedbackGenerator {
     ...
     * one targeted coaching tip. This mirrors Carv's "focus skill" approach.
     */
    ...
    fun generatePostRunFeedback(metrics: SkiMetrics, turns: List<DetectedTurn>): List<String> {
        ...
        tips.add("Ski:IQ ${metrics.skiIQ}/200 — $iqLabel level")
